...
#' Function used for friction factor
...
#' Set up ranges for plot axes, tick marks and labels
...
#' Use three relationships for different portions of graph
# Laminar Portion
...
#' Set up plotting parameters and create diagram
